...
Core library for [github-top-languages](https://github.com/masonlet/github-top-languages) — chart generation, SVG output, and parameter parsing.
...
```bash
npm install github:masonlet/github-top-languages-lib
```
